...
class TestDatabaseWiringTest {
    ...
    void flywayBuildsTheSchemaFromScratch() {
        ...
        assertThat(applied.get(3)).contains("admin_audit");
        assertThat(applied.get(4)).contains("admin_roles");
        assertThat(applied.get(5)).contains("admin_test_players");
        assertThat(applied.get(6)).contains("preserve_last_seen");
        assertThat(applied.get(7)).contains("admin_session_epoch");
        assertThat(applied.get(8)).contains("admin_two_factor");
        assertThat(applied.get(9)).contains("app_setting");
        assertThat(applied.getLast()).contains("player_suspension");
    }
